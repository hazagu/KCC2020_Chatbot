...
{
    public partial class testdispatch : IRecognizerConvert
    {
        public string Text;
        ...
        {
            var app = JsonConvert.DeserializeObject<testdispatch>(JsonConvert.SerializeObject(result, new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore }));
            Text = app.Text;
